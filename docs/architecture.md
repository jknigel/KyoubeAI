...
Kyoube's two plugins working across a core upgrade. For the original design rationale and the
decisions taken before any of this was built, see the spec:
[`superpowers/specs/2026-09-05-kyoubeai-architecture-design.md`](superpowers/specs/2026-09-05-kyoubeai-architecture-design.md)
(§4 Architecture overview, §5 Repository layout, §6.5 Upgrading, §9 Isolation from upstream, §12 Risks and
mitigations) and the five phase plans it spawned:
[Phase 0 — Foundation](superpowers/plans/2026-09-05-phase-0-foundation.md),
[Phase 1 — Terminal plugin](superpowers/plans/2026-09-05-phase-1-terminal-plugin.md),
[Phase 2 — Data layer](superpowers/plans/2026-09-05-phase-2-data-layer.md),
[Phase 3 — Apps](superpowers/plans/2026-09-05-phase-3-apps.md), and
[Phase 4 — Hardening & release](superpowers/plans/2026-09-05-phase-4-hardening-release.md). Each plan's
post-execution notes record where the shipped code differs from the plan text; where this document and a
plan disagree, the code (and this document) win.
