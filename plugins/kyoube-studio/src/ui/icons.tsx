/**
 * Line icons in the same style and weight as the core's (Lucide, 24×24,
 * stroke 2), drawn inline so the plugin ships no icon dependency.
 */
import type { ReactElement } from "react";

const PATHS: Record<string, ReactElement> = {
  build: <><path d="m12 2 10 5-10 5L2 7z" /><path d="m2 17 10 5 10-5M2 12l10 5 10-5" /></>,
  routines: <><path d="m17 2 4 4-4 4" /><path d="M3 11v-1a4 4 0 0 1 4-4h14" /><path d="m7 22-4-4 4-4" /><path d="M21 13v1a4 4 0 0 1-4 4H3" /></>,
  plus: <path d="M12 5v14M5 12h14" />,
  org: <><rect x="9" y="2" width="6" height="6" rx="1" /><rect x="2" y="16" width="6" height="6" rx="1" /><rect x="16" y="16" width="6" height="6" rx="1" /><path d="M5 16v-3a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v3M12 12V8" /></>,
  ...
  timeline: <><path d="M3 3v18h18" /><path d="M7 8h7M10 12h8M7 16h6" /></>,
